...
```{python}
#| fig-cap: "Each shop's productivity split by boss presence, showing the delta (difference) in cars fixed"
#| fig-width: 10
#| fig-height: 10
...
# Set font for this chart
plt.rcParams['font.family'] = 'Georgia'

colors_shops = ['#E74C3C', '#3498DB', '#2ECC71', '#9B59B6', '#F39C12']
...
for i, shop in enumerate(range(1, 6)):
    ...
    ax.set_ylabel('Cars Fixed', fontweight='bold')
    ax.set_title(f'{shop_names[i]}', fontsize=14, fontweight='bold', color=colors_shops[i])
    ax.set_ylim(0, 75)
...
# Add overall title
fig.suptitle('Boss Presence Impact: Delta by Shop', fontsize=16, fontweight='bold', y=0.98)
