...
# Calculate TOTAL monthly profits (baseline + extra from visits)
scenarios = {
    'Never Visit\n(Baseline)': baseline_monthly_profit,
    'Random Visits\n(Current)': baseline_monthly_profit + current_boost * 22 * profit_per_car,
    "Brother's Shop\n(Shop 3 Only)": baseline_monthly_profit + brother_boost * 22 * profit_per_car,
    'Optimal Strategy\n(Shop 1 & 4)': baseline_monthly_profit + best_boost * 22 * profit_per_car
}
...
ax.set_ylabel('Total Monthly Profit ($)', fontsize=12, fontweight='bold')
...
ax.set_ylim(0, max(scenarios.values()) * 1.15)
