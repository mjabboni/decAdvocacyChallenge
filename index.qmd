...
for i, shop in enumerate(range(1, 6)):
    ...
    # Get sample sizes first for labels
    ...
    ax.text(0, -6, f'(n={n_away})', ha='center', fontsize=9, style='italic')
    ax.text(1, -6, f'(n={n_present})', ha='center', fontsize=9, style='italic')

# Add legend to the first subplot
from matplotlib.patches import Patch
legend_elements = [Patch(facecolor='#E67E22', label='You Away'),
                   Patch(facecolor='#27AE60', label='You Present')]
axes[0].legend(handles=legend_elements, loc='upper right', fontsize=10, title='Your Presence', 
               title_fontsize=10, frameon=True)

fig.suptitle('Daily Productivity Split by Shop: Boss Presence Delta', fontsize=16, fontweight='bold', y=0.995)
plt.tight_layout()
...
for i, shop in enumerate(shop_ids):
    ...
    delta_color = '#27AE60' if delta > 0 else '#E74C3C'
    delta_label = f'+{delta:.1f}' if delta > 0 else f'{delta:.1f}'
    ax.text(i, 72, f'Δ {delta_label}', ha='center', fontsize=10, fontweight='bold', color=delta_color,
...
ax.text(0.98, 0.02, '◆ = Mean', transform=ax.transAxes, fontsize=9, ha='right', va='bottom',
