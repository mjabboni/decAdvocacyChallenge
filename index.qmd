...
author: "Your Business Analytics Team"
date: today
format:
  html:
    theme: flatly
...
y_jittered = carsDF['boss'] + np.random.uniform(-jitter_y, jitter_y, len(carsDF))
...
# Add mean surfaces/bars for each shop-boss combination
for shop in range(1, 6):
    for boss in [0, 1]:
        ...
        ax.bar3d(shop - 0.2, boss - 0.1, 0, 0.4, 0.2, mean_cars, 
